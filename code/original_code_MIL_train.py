...
parser.add_argument('--workers', default=30, type=int, help='number of data loading workers (default: 4)')
...
def main():
    ...
    model.cuda()
    ch = torch.load('output/checkpoint_best.pth')
    model.load_state_dict(ch['state_dict'])
    best_acc = ch['best_acc']
    print(best_acc)
    print(ch['epoch'])
